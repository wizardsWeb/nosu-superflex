        ...
        this.list = [
            {
                ...
                [
                    ...
                    './models/projects/threejsJourney/slideC.jpeg',
                    './models/projects/threejsJourney/slideD.jpeg'
                ],
                floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
                link:
                {
                    href: 'https://www.formula1.com/en/racing/2025/monaco',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://www.formula1.com/en/racing/2025/great-britain',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://www.formula1.com/en/racing/2025/belgium',
                    x: - 4.8,
                    y: - 2,
                    halfExtents:
                    {
